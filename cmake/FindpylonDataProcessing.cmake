...
elseif(MSVC)
  ...
  set(_PYLON_DATAPROCESSING_SDK_LIB_SEARCH_PATH)
  if(DEFINED PYLON_DEV_DIR)
    if(CMAKE_SIZEOF_VOID_P EQUAL 8)
      list(APPEND _PYLON_DATAPROCESSING_SDK_LIB_SEARCH_PATH "${PYLON_DEV_DIR}/lib/x64")
    else()
      list(APPEND _PYLON_DATAPROCESSING_SDK_LIB_SEARCH_PATH "${PYLON_DEV_DIR}/lib/Win32")
    endif()
  endif()
  ...
  # Match setup.py / CopyRuntimeDeps: accept any PylonDataProcessing_v*.lib version
  set(_PYLON_DATAPROCESSING_SDK_LIBS)
  foreach(_lib_dir IN LISTS _PYLON_DATAPROCESSING_SDK_LIB_SEARCH_PATH)
    file(GLOB _libs "${_lib_dir}/PylonDataProcessing_v*.lib")
    list(APPEND _PYLON_DATAPROCESSING_SDK_LIBS ${_libs})
  endforeach()
  if(_PYLON_DATAPROCESSING_SDK_LIBS)
    list(SORT _PYLON_DATAPROCESSING_SDK_LIBS COMPARE NATURAL ORDER DESCENDING)
    list(GET _PYLON_DATAPROCESSING_SDK_LIBS 0 pylonDataProcessing_LIBRARIES)
  endif()
...
elseif(UNIX)
  # Find pylon-dataprocessing-config tool
